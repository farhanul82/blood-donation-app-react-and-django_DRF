      ...
      <div className="row">
        ...
        <div className="col-md-6">
          <form className="loginFom" onSubmit={(e) => onSubmit(e)}>
            <div className='loginImgDIv pt-3'>
              <img alt='' src='/images/login.jpg'></img>
            </div>
            ...
            <div className='d-flex justify-content-center'>
              <div>
                <button className="btn  loginButtn" type="submit">
                  Login
                </button>
                <br></br>

                <button className="btn btn-danger googlebtn mt-3" onClick={continueWithGoogle}>
                <img className src="https://cdn.cdnlogo.com/logos/g/35/google-icon.svg"></img>
                  Continue With Google
                </button>
                <br />
                {/* <button
                  className="btn btn-primary fa mt-3"
