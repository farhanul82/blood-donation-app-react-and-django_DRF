              ...
              return (
                ...
                <div className="col-md-4  d-flex justify-content-center">
                  <Card className=" card frineds_card">
                    <CSRFToken />
                    <Card.Img className="friend_card_img"  src="http://localhost:8000/media/profilepic/images/face_Uz08K7w.jpg" />
                    <Card.Body>
                      <Card.Title className="text-center">{item.senderProfile[0].name}</Card.Title>
                      <Card.Text>
