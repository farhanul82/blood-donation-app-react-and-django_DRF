        ...
        <div className="container mt-5">
          <div className="row">
            <div className="col-md-6 ">
              ...
              <div className="donorsGifDiv  d-flex justify-content-center">
            ...
            <div className="col-md-6 ">
              <div className="donorHeadingDIV  d-flex justify-content-center">
                ...
                donors.map(item => {
                  ...
                  return (
                    <div className="col-md-4">
                      <Card className="DonorSearchcard">
                        <CSRFToken />
                        <Card.Img className="Donor_Search_card_img" variant="top" src={item.image} />
                        <Card.Body>
                          ...
                          <div className=" d-flex justify-content-around">
                            <Button className="searchDonorsProfile" onClick={() => sendProfileId(item.id)} variant="primary">Profile</Button>
                            <Button onClick={() => sendRequest(item.user.id)} className="btn btn-danger requestDonateBtn" variant="primary">Request to Donate</Button>
                          </div>
