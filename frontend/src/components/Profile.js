    ...
    <div>
      {profile.city ? (
        <div>
          ...
          <div className="container UserprofileDIv">
            <div className="row">
              <div className="col-md-6">


                <div className="UserprofileimgDiv  d-flex justify-content-center">
                  <img
                ...
                <div className="userprofileNameDiv  d-flex justify-content-center">
                  <h4>{profile.name}</h4>
                </div>

                <div className="userprofileGroupDiv d-flex justify-content-around">
              ...
              <div className="col-md-6 ">
                ...
                <div className="  d-flex justify-content-center">
                  ...
                  <div className="UserprofileInfoDiv  d-flex justify-content-center">
          ...
          <div className="container ">
            <div className="row my-3">
              <div className="col-md-12">
                ...
                <div className=" d-flex justify-content-center">
                  <Button className="addPostBtn d-flex justify-content-center" onClick={handleShow}>
                    Write your post . . . . .
                  </Button>
                </div>
